...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp11(int p0, string p1, out CallLuaTest.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = (CallLuaTest.DClass)translator.GetObject(L, errFunc + 2, typeof(CallLuaTest.DClass));
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CallLuaTest.FDelegate))
			{
			    return new CallLuaTest.FDelegate(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(CallLuaTest.GetE))
			{
			    return new CallLuaTest.GetE(__Gen_Delegate_Imp12);
			}
