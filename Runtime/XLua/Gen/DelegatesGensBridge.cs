...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(int p0, string p1, out CallLuaTest.DClass p2)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new CallLuaTest.FDelegate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(CallLuaTest.GetE))
			{
			    return new CallLuaTest.GetE(__Gen_Delegate_Imp1);
			}
