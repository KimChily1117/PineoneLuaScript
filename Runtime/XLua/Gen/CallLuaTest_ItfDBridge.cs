...
{
    public class CallLuaTestItfDBridge : LuaBase, CallLuaTest.ItfD
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new CallLuaTestItfDBridge(reference, luaenv);
		}
		
		public CallLuaTestItfDBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int CallLuaTest.ItfD.add(int a, int b)
		{
