...
namespace XLua.CSObjectWrap
{
    ...
    public class EnumKYCWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(EnumKYC), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(EnumKYC), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(EnumKYC), L, null, 3, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "E1", EnumKYC.E1);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "E2", EnumKYC.E2);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(EnumKYC), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushEnumKYC(L, (EnumKYC)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushEnumKYC(L, EnumKYC.E1);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "E2"))
                {
                    translator.PushEnumKYC(L, EnumKYC.E2);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for EnumKYC!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for EnumKYC! Expect number or string, got + " + lua_type);
            }
